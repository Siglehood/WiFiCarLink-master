package com.gec.wificarlink.widget;

import com.gec.wificarlink.util.MathUtil;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (event.getAction() == MotionEvent.ACTION_MOVE) {
			...
			if (len <= mRangeRadius) {
				...
				mRockerPosition = MathUtil.getBorderPoint(mCtrlPoint, new Point((int) event.getX(), (int) event.getY()),
						mRangeRadius);
			}
